      ...
      <div className="woman__text">
        ...
        <div className="woman__text__block">
          <ul className="woman__text__block__image">
            <li>
              <img src={ellipse25} alt="img" />
              Biman BD Airline
            </li>
            <li>
              <img src={ellipse26} alt="img" />
              Badal Airline
            </li>
            <li>
              <img src={ellipse27} alt="img" />
              Raza Airline
            </li>
          </ul>
          <ul className="woman__text__block__image">
            <li>
              <img src={ellipse28} alt="img" />
              Hello Int. Airlines
            </li>
            <li>
              <img src={ellipse29} alt="img" />
              Pakistan International Airlines
            </li>
            <li>
              <img src={ellipse30} alt="img" />
              Hello International Airlines
            </li>
          </ul>
        </div>
      </div>
      <div className="woman__image" />
    </div>
  );
}
